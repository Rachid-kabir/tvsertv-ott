...
export default function SubscriptionForm() {
    ...
    const subscriptionOptions = [
        ...
        { value: "3 MOIS", price: "24.99 €", label: "3 MOIS", popular: true },
        { value: "6 MOIS", price: "29.99 €", label: "6 MOIS" },
                                            ...
                                            {subscriptionOptions.map((option) => (
                                                <label
                                                    ...
                                                    className={`relative flex items-center p-4 rounded-lg border-2 cursor-pointer transition-all ${
                                                        option.popular ? "border-orange-500 bg-orange-50" : "border-gray-200 hover:border-orange-300"
                                                    }`}
                                                >
                                                    <input type="radio" value={option.value} {...register("subscription")} className="sr-only" />
